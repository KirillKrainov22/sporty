...
**Целевая аудитория:** студенты и молодые специалисты 18–35 лет.
...
1. Схема архитектуры микросервисов (Miro)
2. Краткий рассказ: какую проблему решаем и для кого
3. QR-код на Telegram-бота
4. Демонстрация работы веб-интерфейса
5. Распределение ролей в команде (кто что делал)
...
* отсутствие общих файлов и shared volumes для бизнес-логики
````
