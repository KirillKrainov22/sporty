...
try:
    ...
    if isinstance(mock_stats, dict):
        print(f"   ✅ Mock data: {mock_stats.get('total_points', 'N/A')} points")
    else:
        print("   ❌ Mock data not a dict")
except Exception as e:
...
try:
    ...
    if isinstance(chart_data, dict):
        print(f"   ✅ Data utils work")
    else:
        print("   ❌ Data utils returned wrong type")
except Exception as e:
